...
function DragHandle({ id }: { id: number }) {
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">Yeniden sıralamak için sürükleyin</span>
    </Button>
  );
}
...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  {
    accessorKey: "limit",
    header: () => <div className="w-full text-right">Sınır</div>,
    cell: ({ row }) => (
      <form
        onSubmit={(e) => {
          e.preventDefault();
  ...
  },
  {
    ...
    header: "İnceleyici",
    cell: ({ row }) => {
      const isAssigned = row.original.reviewer !== "İnceleyici ata";
    ...
    cell: () => (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-32">
          ...
          <DropdownMenuItem>Kopyasını oluştur</DropdownMenuItem>
      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            ...
            <SelectItem value="key-personnel">Anahtar Personel</SelectItem>
        ...
        <TabsList className="**:data-[slot=badge]:bg-muted-foreground/30 hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:px-1 @4xl/main:flex">
          ...
          <TabsTrigger value="key-personnel">
            Anahtar Personel <Badge variant="secondary">2</Badge>
          </TabsTrigger>
    ...
    <Drawer direction={isMobile ? "bottom" : "right"}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>Son 6 ayın toplam ziyaretçileri gösteriliyor</DrawerDescription>
        </DrawerHeader>
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
            ...
            <>
              ...
              <div className="grid gap-2">
                <div className="flex gap-2 leading-none font-medium">
                  Bu ay %5,2 artış <IconTrendingUp className="size-4" />
                </div>
                <div className="text-muted-foreground">
                  Son 6 ayın toplam ziyaretçileri gösteriliyor. Bu, düzeni test etmek için rastgele
                  bir metindir. Birden fazla satırı kaplar ve etrafında sarılmalıdır.
                </div>
              </div>
              <Separator />
            </>
          ...
          <form className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Select defaultValue={item.type}>
                  <SelectTrigger id="type" className="w-full">
                    <SelectValue placeholder="Türü seç" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="Table of Contents">İçindekiler Tablosu</SelectItem>
                    <SelectItem value="Executive Summary">Yönetici Özeti</SelectItem>
                    <SelectItem value="Technical Approach">Teknik Yaklaşım</SelectItem>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-3">
                <Label htmlFor="limit">Sınır</Label>
        ...
        <DrawerFooter>
          ...
          <DrawerClose asChild>
            <Button variant="outline">Bitti</Button>
          </DrawerClose>
        </DrawerFooter>
      </DrawerContent>
    </Drawer>
